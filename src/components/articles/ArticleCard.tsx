...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, collection }) => {
  ...
  return (
    <div onClick={handleCardClick}>
      <Card className="w-[280px] h-[360px] md:shadow-xl border md:border-2 border-stone-100 md:border-stone-300 hover:shadow-2xl hover:drop-shadow-2xl duration-300 text-center hover:cursor-pointer">
