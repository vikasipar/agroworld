...
const Hero = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center h-[94dvh] lg:h-[84dvh] w-[96%] lg:w-[93%] mx-auto">
      <div className="w-[94%] mx-auto md:w-[57%] mb-6 md:mb-0">
      ...
      <div className="w-[90%] mx-auto md:w-[43%] space-y-1 md:space-y-3 text-justify">
        ...
        <h2 className="text-xl md:text-3xl font-semibold text-green-600 text-center md:text-left">Grow smarter, farm better!</h2>
